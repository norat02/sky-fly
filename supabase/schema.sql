-- ==============================================================================
-- Whisper Social & Chat Platform — Production Supabase Schema
-- ==============================================================================
...
-- Enable Realtime for live chat, stories, follows, and notifications
DO $$
BEGIN
  IF NOT EXISTS (
...
-- ==============================================================================
-- 8. Storage Buckets Setup (Run in SQL Editor or Storage tab)
-- ==============================================================================
...
CREATE POLICY "Public Posts Media Access" ON storage.objects FOR SELECT USING (bucket_id = 'posts');
CREATE POLICY "Authenticated Posts Media Upload" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'posts' AND auth.role() = 'authenticated');

CREATE POLICY "Public Stories Media Access" ON storage.objects FOR SELECT USING (bucket_id = 'stories');
CREATE POLICY "Authenticated Stories Media Upload" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'stories' AND auth.role() = 'authenticated');

CREATE POLICY "Public Chat Media Access" ON storage.objects FOR SELECT USING (bucket_id = 'chat_media');
CREATE POLICY "Authenticated Chat Media Upload" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'chat_media');
